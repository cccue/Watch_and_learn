...
var globalresponse;
var calledonce_sim_color = 0;
var calledonce_sim_desg = 0;
...
function process_image(response) {
    ...
    tag_html += "<span class=\"input-group-btn\"><button class=\"btn btn-default\" type=\"button\" onclick=\"show_sim_color_images();\">Find similar watches (color based)</button></span></div>\n";
    tag_html += "</div> <br>";

    tagElement = document.createElement("div");
    //tagElement.classList.add("row");
    tagElement.classList.add("col-md-4");
    ...
    var tag_html = "<div class=\"container-fluid tag-form\">";
    tag_html += "<div class=\"input-group input-group select2-bootstrap-append\">"
    tag_html += "<span class=\"input-group-btn\"><button class=\"btn btn-default\" type=\"button\" onclick=\"show_sim_desg_images();\">Find similar watches (design based)</button></span></div>\n";
    tag_html += "</div> <br>";
...
function show_sim_color_images() {
            
	    var images = globalresponse.sim_image_color_urls;
            var tag_html = "<br> <br> <center> <h4><font color=\"white\"> Color similarity </font> </h4> </center> <div class=\"container-fluid carousel-container\"><div id=\"carouselsim\" class=\"carousel slide\" data-ride=\"carousel\"><ol class=\"carousel-indicators\">\n";
            ...
            tagElement.innerHTML = tag_html;
            if(calledonce_sim_color == 0 ){
	    document.body.appendChild(tagElement);}
	    calledonce_sim_color = 1;
//      }
//);
}


function show_sim_desg_images() {
            
	    var images = globalresponse.sim_image_desg_urls;
            var tag_html = "<br> <br> <center> <h4><font color=\"white\"> Design similarity </font> </h4> </center> <div class=\"container-fluid carousel-container\"><div id=\"carouselsim1\" class=\"carousel slide\" data-ride=\"carousel\"><ol class=\"carousel-indicators\">\n";
            for (var i = 0; i < images.length; i++) {
                tag_html += "<li data-target=\"#carouselsim1\" data-slide-to=\"" + i + "\"></li>\n";
            }
            tag_html += "</ol><div class=\"carousel-inner\" role=\"listbox\">\n";
            for (var i = 0; i < images.length; i++) {
                tag_html += "<div class=\"item" + ((i==0) ? " active" : "") + "\"><img src=\"static/"+images[i]+"\"></div>\n";
            ...
            tag_html += "<a class=\"left carousel-control\" href=\"#carouselsim1\" role=\"button\" data-slide=\"prev\">\n";
            tag_html += "  <span class=\"glyphicon glyphicon-chevron-left\" aria-hidden=\"true\"></span>\n";
            tag_html += "  <span class=\"sr-only\">Previous</span>\n";
            tag_html += "</a>\n";
            tag_html += "<a class=\"right carousel-control\" href=\"#carouselsim1\" role=\"button\" data-slide=\"next\">\n";
            tag_html += "  <span class=\"glyphicon glyphicon-chevron-right\" aria-hidden=\"true\"></span>\n";
            tag_html += "  <span class=\"sr-only\">Next</span>\n";
            tag_html += "</a>\n";
            tag_html += "</div></div>\n";
            ...
            //tagElement.classList.add("searchresults");
            tagElement.innerHTML = tag_html;
            if(calledonce_sim_desg == 0 ){
	    document.body.appendChild(tagElement);}
	    calledonce_sim_desg = 1;
//      }
//);
}
...
function show_rand_images() {
	    ...
	    var images = globalresponse.rand_image_urls;
            var tag_html = "<br> <br> <center> <h4><font color=\"white\"> Random retrieval </font> </h4> </center> <div class=\"container-fluid carousel-container\"><div id=\"carousel\" class=\"carousel slide\" data-ride=\"carousel\"><ol class=\"carousel-indicators\">\n";
            for (var i = 0; i < images.length; i++) {
